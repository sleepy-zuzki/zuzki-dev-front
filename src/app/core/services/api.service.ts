...
export class ApiService {
   ...
   */
  public getFromGithub<T>(endpoint: string): Observable<T> {
    return this.http.get<T>(endpoint, {
      context: new HttpContext().set(API_TYPE, ApiType.GITHUB)
    });
  }
   ...
   * @returns Observable con la respuesta
   */
  public postToGithub<T>(endpoint: string, body: any): Observable<T> {
